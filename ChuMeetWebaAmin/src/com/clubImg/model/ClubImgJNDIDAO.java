...
public class ClubImgJNDIDAO implements ClubImgDAO_interface {
	...
	private static final String INSERT_STMT = 
			"INSERT INTO clubImg (clubImgID,clubAlbumID,memID,clubImgDate,clubImgContent,clubImgStatus) VALUES (clubImg_seq.NEXTVAL, ?, ?, ?, ?, ?)";
		private static final String GET_ALL_STMT = 
			"SELECT clubImgID,clubAlbumID,memID,clubImgDate,clubImgContent,clubImgStatus FROM clubImg order by clubImgID";
		private static final String GET_ONE_STMT = 
			"SELECT clubImgID,clubAlbumID,memID,clubImgDate,clubImgContent,clubImgStatus FROM clubImg where clubImgID = ?";
//		private static final String DELETE = 
//			"DELETE FROM club where clubID = ?";
		private static final String UPDATE = 
			"UPDATE clubImg set clubAlbumID=?, MemID=?, clubImgDate=?, clubImgContent=?, clubImgStatus=? where clubImgID = ?";
	...
	public void insert(ClubImgVO clubImgVO) {
		...
		try {
			...
			pstmt.setDate(3, clubImgVO.getClubImgDate());
			pstmt.setString(4, clubImgVO.getClubImgContent());
			pstmt.setInt(5, clubImgVO.getClubImgStatus());
	...
	public void update(ClubImgVO clubImgVO) {
		...
		try {
			...
			pstmt.setString(4, clubImgVO.getClubImgContent());
			pstmt.setInt(5, clubImgVO.getClubImgStatus());
			pstmt.setInt(6, clubImgVO.getClubImgID());
	...
	public ClubImgVO findByPrimaryKey(Integer clubImgID) {
		...
		try {
			...
			while (rs.next()) {
				...
				clubImgVO.setClubImgDate(rs.getDate("clubImgDate"));
