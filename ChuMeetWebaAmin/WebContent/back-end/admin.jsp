						...
						<table class="table table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td><c:forEach var="adminVO" items="${list}"
											begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
											<FORM METHOD="post"
												ACTION="<%=request.getContextPath()%>/back-end/admin.do">
												<input type="submit" value="修改"> <input
													type="hidden" name="empno" value="${adminVO.adminID}">
												<input type="hidden" name="action" value="getOne_For_Update">
											</FORM></td>
									<td>
										<FORM METHOD="post"
											ACTION="<%=request.getContextPath()%>/back-end/admin.do">
											<input type="submit" value="暫停"> <input type="hidden"
												name="empno" value="${adminVO.adminID}"> <input
								...
								<tr>
									...
									<td><span class="btn-group">
											<button type="button" class="btn btn-danger btn-sm statbtn"
												name="actStatID" value="5">修改</button>
									</span>
										<button class="btn btn-sm btn-warning">暫停</button></td>
								</tr>
