...
<a href="<%=request.getContextPath()%>/back-end/admin.do"><i
						...
						<c:if test="${admPrilVO.admPrilID==2}">
							...
							</c:choose><a href="<%=request.getContextPath()%>/back-end/ann.do"><i class="material-icons">person</i>
									<p>
										<strong>網站管理</strong>
									</p></a></li>
						</c:if>
						...
						<c:if test="${admPrilVO.admPrilID==3}">
							...
							<a href="<%=request.getContextPath()%>/back-end/app.do"><i
						...
						<c:if test="${admPrilVO.admPrilID==4}">
							...
							</c:choose><a href="<%=request.getContextPath()%>/back-end/member.do"><i
						...
						<c:if test="${admPrilVO.admPrilID==5}">
							...
							</c:choose><a href="<%=request.getContextPath()%>/back-end/achReward.do"><i
									class="material-icons text-gray">face</i>
									<p>
						...
						<c:if test="${admPrilVO.admPrilID==6}">
							...
							</c:choose><a href="<%=request.getContextPath()%>/back-end/ticket.do"><i
						...
						<c:if test="${admPrilVO.admPrilID==7}">
							...
							</c:choose><a href="<%=request.getContextPath()%>/back-end/poi.do"><i class="material-icons">location_on</i>
									<p>
						...
						<c:if test="${admPrilVO.admPrilID==8}">
							...
							</c:choose><a href="<%=request.getContextPath()%>/back-end/act.do"><i
						...
						<c:if test="${admPrilVO.admPrilID==9}">
							...
							</c:choose><a href="<%=request.getContextPath()%>/back-end/club.do"><i
